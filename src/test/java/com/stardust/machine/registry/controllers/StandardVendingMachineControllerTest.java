...
public class StandardVendingMachineControllerTest {
    ...
    public void machineServiceShouldRegisterPackage() {
        String response = RestAssuredMockMvc
                ...
                .body(packageProduct)
                .when()
                .post("/api/v101/machines/machine_sn/packages/stock?token=" + registry.getToken())
                .asString();
    ...
    public void machineServiceShouldReturn400WhenTokenInvalid() {
        RestAssuredMockMvc
                ...
                .body(packageProduct)
                .when()
                .post("/api/v101/machines/machine_sn_another/packages/stock?token=" + registry.getToken())
    ...
    public void machineServiceShouldRegisterSoldPackage() {
        String response = RestAssuredMockMvc
                ...
                .body(packageProduct)
                .when()
                .post("/api/v101/machines/machine_sn/packages/sold?token=" + registry.getToken())
                .asString();
    ...
    public void machineServiceShouldRegisterOrder() {
        ...
        String response = RestAssuredMockMvc
                ...
                .body(order)
                .when()
                .post("/api/v101/machines/machine_sn/orders?token=" + registry.getToken())
                .asString();
